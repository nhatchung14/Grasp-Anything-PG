...
from inference.models.groundingdino.util import box_ops, get_tokenlizer
from inference.models.groundingdino.util.misc import (
    NestedTensor,
    accuracy,
    get_world_size,
    interpolate,
...
from inference.models.groundingdino.util.utils import get_phrases_from_posmap
from inference.models.groundingdino.util.visualizer import COCOVisualizer
from inference.models.groundingdino.util.vl_utils import create_positive_map_from_span
...
class GroundingDINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets: List = None, **kw):
        ...
        hs, reference, hs_enc, ref_enc, init_box_proposal, image_memory, text_memory = self.transformer(
